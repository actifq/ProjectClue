...
public CardSelect()
   ...
   add(p4);
   add(p5);
   //System.out.println(p[0].getWidth());
   /*setCardImg(p, "player");
   setCardImg(q, "weapon");
   setCardImg(j, "room");*/
...
public void setCardImg(){
      ...
      for(int i=0;i<p.length;i++)
      {
         /*p[i].setIcon(new ImageIcon("image/player/char"+i+".jpg"));
         q[i].setIcon(new ImageIcon("image/weapon/wp"+i+".jpg"));
         j[i].setIcon(new ImageIcon("image/room/room"+i+".jpg"));*/
         ...
         j[i].setIcon(new ImageIcon(setImage("image/room/room"+i+".jpg",j[0].getWidth(),j[0].getHeight())));
            //jb[i].setIcon(new ImageIcon(setImage("image/player/char"+card+i+".jpg",jb[0].getWidth(),jb[0].getHeight())));

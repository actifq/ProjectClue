...
public class GameNote2 extends JPanel{
	...
	public GameNote2() {
		...
		JLabel lb3 = new JLabel(" ¹«±â");
		JLabel lb4 = new JLabel(" ");
		lb3.setFont(new Font("", Font.BOLD, 13));
		wp1=new JCheckBox("È°");
		wp2=new JCheckBox("»ð");
		wp3=new JCheckBox("ºñ¼Ò");
		wp4=new JCheckBox("¹åÁÙ");
		wp5=new JCheckBox("°î±ªÀÌ");
		wp6=new JCheckBox("ÀºÀåµµ");
		wp7=new JCheckBox("ºÎÁö²¤ÀÌ");
		wp8=new JCheckBox("Àý±¸°øÀÌ");
		nt7=new JTextField();
		nt8=new JTextField();
		nt9=new JTextField();
		nt10=new JTextField();
